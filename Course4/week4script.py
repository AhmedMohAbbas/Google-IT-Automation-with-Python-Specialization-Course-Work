...
def get_same_or_newer(start_date, data_dic):
    ...
    min_date_employees = []
    for employee,dat in data_dic.items():
        ...
        # employees at the minimal date.
            ...
            min_date_employees.append(employee)
...
def list_newer(start_date):
    ...
    for row in reader:
        ...
        TheEmployee = "{} {}".format(row[0], row[1])
        data_dic[TheEmployee] = row_date
    while start_date < datetime.datetime.today():
        start_date, employees = get_same_or_newer(start_date, data_dic)
        if len(employees) > 0:
